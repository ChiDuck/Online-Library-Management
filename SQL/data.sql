...
--INSERT INTO CHITIETPHIEUTRA VALUES		-- Mã phiếu, mã sách
--(1, 2), 
--(1, 3),
--(2, 5)
...
select * from CHITIETPHIEUMUON join PHIEUMUONSACH on PHIEUMUONSACH.MAPHIEU = CHITIETPHIEUMUON.MAPHIEU
where PHIEUMUONSACH.MADOCGIA = 1
